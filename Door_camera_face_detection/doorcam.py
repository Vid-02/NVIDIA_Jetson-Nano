...
def get_jetson_gstreamer_source(capture_width=640, capture_height=480, display_width=640, display_height=480, framerate=30, flip_method=0):
    """
    ...
    while True:
        ...
        for metadata in known_face_metadata:
            ...
            if datetime.now() - metadata["last_seen"] < timedelta(seconds=10) and metadata["seen_frames"] > 5:
                ...
                #write jpjg file with timestamp
                ...
                if visits == 1:
                    ...
                    if temp:
                        ...
                        # then create it.
                            ...
                            os.makedirs(date)
                            filename = str(date+'/'+time_now+".jpg")
                            cv2.imwrite(filename, frame[30:180, x_position:x_position + 150])
                    temp = False
